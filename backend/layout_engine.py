        ...
        for shape in shapes:
            ...
            if not shape.get("is_flow", True) or shape["height"] < 0.5:
                ...
                while scale >= 0.6:
                    ...
                    # Use a safety factor (75% of width) to account for bold character expansion, kerning, and WeasyPrint margins
                    est_h = estimate_text_height(shape["resolved_text"], font_path, original_size * scale, usable_w * 0.75)
                ...
                est_h = estimate_text_height(shape["resolved_text"], font_path, original_size * best_scale, usable_w * 0.75)
